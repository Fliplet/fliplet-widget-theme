...
export function migrateOldVariables(data) {
  ...
  Fliplet.Utils.forIn(data, (value, key) => {
    ...
    if (typeof migrationMapping[key] === 'string') {
      ...
      if (data[migrationMapping[key]] == null) {
    ...
    if (typeof migrationMapping[key] === 'object' && migrationMapping[key] !== null && !Array.isArray(migrationMapping[key]) && Object.getPrototypeOf(migrationMapping[key]) === Object.prototype) {
      ...
      if (value === 'none') {
        ...
        if (data[migrationMapping[key].none] == null) {
